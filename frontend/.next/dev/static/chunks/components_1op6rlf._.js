...
function UploadDropzone({ onUpload, accept = ".pdf,.jpg,.png", maxSizeMB = 10, multiple = false }) {
    ...
    const handleFileChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "UploadDropzone.useCallback[handleFileChange]": (e)=>{
            if (onUpload && e.target.files && e.target.files.length > 0) {
                onUpload(e.target.files);
            }
        }
    }["UploadDropzone.useCallback[handleFileChange]"], [
        onUpload
    ]);
...
_s(UploadDropzone, "SrqVEDtZJPNseN0IoieOBnkruxg=");
_c = UploadDropzone;
var _c;
...
//# sourceMappingURL=components_1op6rlf._.js.map